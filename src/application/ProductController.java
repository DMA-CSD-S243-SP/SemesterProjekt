...
/**
 * Represent a Controller for product its responsible for handling
...
public class ProductController
{
	 ...
	 * 
	 * It delegates the actual search to the ProductContainer class and ensures the
	 * controller does not handle data storage directly.
	 * 
	 * @param product ID - the product ID of the product that needs to be found
	 * @return customer - Product object that match the given product ID or return
	 *         null if no product is found.
	 */
